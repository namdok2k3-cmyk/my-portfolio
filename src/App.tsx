...
import { Github, ExternalLink, Mail, Code, Gamepad2, Star, ChevronRight, Terminal, Cpu, Linkedin, X, Sparkles, Loader2, Copy, Check, Minus, Maximize2, Minimize2, BadgeCheck, MessageCircle } from 'lucide-react';
...
const callGemini = async (prompt: string, systemContext: string) => {
  ...
  if (!apiKey) {
      if (prompt.includes("overview")) return "My name is Nam, I'm a Computer Science student at UNB, passionate about solving real-world problems using new technology—whether it's building cool video games or creating meaningful solutions for the community!";
      if (prompt.includes("tech")) return "I'm proficient in Python, JavaScript, and React for building interactive apps. I'm also a master of Excel, Word, and the Microsoft Suite. My strength lies in collaboration and teamwork—together we can build anything!";
      
      if (prompt.includes("experience")) return "I interned at the Fredericton Fire Department designing emergency maps (Data/Research) to help people when it counts the most. I also worked as a Prompt Engineer (AI Trainer) at Outlier.ai, gaining hands-on experience with LLMs and AI. Besides that, I was a Teaching Assistant for Algorithm Design at UNB and honed my leadership skills as a Gym Supervisor at UNB Reds Recreation.";
      
      if (prompt.includes("collab")) return "Yes, I would love to! I thrive in team environments. Shoot me a message on LinkedIn or Email me directly!";
  ...
  try {
    ...
    return data.candidates?.[0]?.content?.parts?.[0]?.text || "I couldn't think of a response right now.";
  } catch (e) {
    console.error(e);
...
const App = () => {
  ...
  const projects = [
    {
      ...
      category: "Game",
      description: "A real-time strategy auto-battler inspired by Clash Royale. Features intelligent unit AI, resource management, and a dark fantasy aesthetic.",
  ...
  const handleQuestionClick = async (questionId: string, label: string) => {
    ...
    const systemContext = `
      ...
      RESUME FACTS (USE THESE EXACTLY):
      - Education: CS Student at UNB (2021-2026).
      - Prompt Engineer / AI Trainer at Outlier.ai: Highlight experience with AI models and attention to detail.
      - Internship (Fredericton Fire Dept): Designed Emergency Maps, Data Analysis, Research to help people when it counts.
      - Teaching Assistant (Algorithm Design): Developed collaboration skills, grading, mentoring.
      - Gym Supervisor: Improved data analysis and leadership skills.
      - Tech Stack: Python, JavaScript, React, Algorithm Design. Master of Excel, Word, Microsoft Suite.
      - Passion: Solving real-world problems, building games, giving back to community.
      - Strength: Collaboration and Teamwork.
    `;

    switch (questionId) {
        case 'overview':
            prompt = "Write a heart-touching overview. Start with 'My name is Nam...'. Mention passion for solving real-world problems with new tech, building cool video games, or meaningful things to give back to the community and the people!";
            break;
        case 'tech':
            prompt = "List his tech stack exactly like this: 'I'm proficient in Python, JavaScript, and React, algorithm design for building interactive apps. I'm also a master of Excel, Word, and the Microsoft Suite. My strength lies best in collaboration, teamwork - together we can build anything and solve any problems'";
            break;
        case 'experience':
            prompt = "Describe experience. Use this EXACT text: 'I interned at the Fredericton Fire Department designing emergency maps (Data/Research) to help people when it counts the most. I also worked as a Prompt Engineer (AI Trainer) at Outlier.ai, gaining hands-on experience with LLMs and AI. Besides that, I was a Teaching Assistant for Algorithm Design at UNB and honed my leadership skills as a Gym Supervisor at UNB Reds Recreation.'";
            break;
        case 'collab':
            prompt = "Is he open to collab? Answer 'Yes, I would love to!'. Tell them to shoot a message on LinkedIn (click the button below).";
            break;
        default:
            prompt = "Say hello!";
    }
        ...
        <div className="max-w-6xl mx-auto text-center md:text-left">
          <div className="max-w-3xl">
            ...
            <p className="text-xl md:text-2xl font-medium leading-relaxed mb-10 max-w-2xl animate-blur-in glass-text" style={{ animationDelay: '0.4s' }}>
              Hi there! My name is Nam. I'm a Computer Science student passionate about game logic and interactive web development. I love learning new things to build something meaningful.
            </p>
      ...
      <div className="fixed bottom-6 right-6 z-50 flex flex-col items-end gap-2 pointer-events-none">
        ...
        {isChatOpen && (
          <div className={`
            ...
            ${isChatMinimized ? 'h-14 w-64 md:w-72 opacity-90' : isChatMaximized ? 'w-[90vw] h-[80vh] fixed right-4 bottom-20' : 'w-64 md:w-72 h-[450px] animate-in slide-in-from-bottom-4'}
          `}>
            {/* Header */}
            <div 
